        ...
        <Card>
          ...
          <CardContent>
            {venuesLoading ? (
              ...
              <div className="text-center text-gray-500 py-6">You have not created any venues yet.</div>
            ) : (
            ...
            <form className="flex flex-col gap-4" onSubmit={handleProfileUpdate}>
              ...
              <label className="flex items-center gap-2">
                <input
                  ...
                  onChange={e => setEditState(s => ({ ...s, venueManager: e.target.checked }))}
                />
                Venue Manager
              </label>
              {editError && <div className="text-red-600 text-sm">{editError}</div>}
              {editSuccess && <div className="text-green-600 text-sm">{editSuccess}</div>}
              <Button type="submit" className="mt-2 w-full" disabled={editLoading}>
